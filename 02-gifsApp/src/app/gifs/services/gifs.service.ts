    ...
    buscarGif(query: string) {
        ...
        this.http.get<SearchGifsResponse>(`${this.giphyAPIUrl}/search`, {params})
            .subscribe(response => {
                ...
                // Ponemos (response:any) en vez de solo response para indicar a TS que no importa de que tipo 
                // es la respuesta, nosotros sabemos que la respuesta tendra un parametro "data"
